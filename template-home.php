	...
	<div class="row">
		...
		<div class="content no-bg">
			...
			<div class="holder third">
				<?php $recent = new WP_Query('page_id='.get_theme_mod('givingpress_lite_page_one')); while($recent->have_posts()) : $recent->the_post(); ?>
			...
			<div class="holder third">
				<?php $recent = new WP_Query('page_id='.get_theme_mod('givingpress_lite_page_two')); while($recent->have_posts()) : $recent->the_post(); ?>
					<?php get_template_part( 'content/home-page', 'small' ); ?>
				<?php endwhile; ?>
				<?php wp_reset_postdata(); ?>
			</div>
			...
			<div class="holder third">
				<?php $recent = new WP_Query('page_id='.get_theme_mod('givingpress_lite_page_three')); while($recent->have_posts()) : $recent->the_post(); ?>
					<?php get_template_part( 'content/home-page', 'small' ); ?>
				<?php endwhile; ?>
				<?php wp_reset_postdata(); ?>
			</div>
...
<?php if ( get_theme_mod( 'givingpress_lite_page_four' ) ) { ?>
	...
	<?php $recent = new WP_Query('page_id='.get_theme_mod('givingpress_lite_page_four')); while($recent->have_posts()) : $recent->the_post(); ?>
